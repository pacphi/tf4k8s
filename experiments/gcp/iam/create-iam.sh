...
gcloud iam service-accounts keys create \
  ...
  ~/.tf4k8s/gcp/${SERVICE_ACCOUNT_NAME}-${PROJECT_ID}-service-account-credentials.json

echo "Find your new service account credentials here [ ~/.tf4k8s/gcp/${SERVICE_ACCOUNT_NAME}-${PROJECT_ID}-service-account-credentials.json ]"
