...
echo "You will also want to generate a new private/public key pair. Execute [ ssh-keygen -t rsa -b 4096 -C {email-address} ].  Note the fully-qualified path to the public key."