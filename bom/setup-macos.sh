...
brew install awscli aws-iam-authenticator aliyun-cli azure-cli doctl git gpg graphviz libressl openssl terraform terraform-docs tflint httpie kubernetes-cli helm helmfile krew octant
